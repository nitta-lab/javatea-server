...
public class AnswerRepository {
    ...
    public AnswerRepository() {
        // test用
        createAnswer("qid1", "まず図書館の中に入ってください。そのあと、左手に向かって進めばとりあえずパソコンはあります", "test02", "testUser02");
        createAnswer("qid1", "分からん。すまんかった。", "test03", "testUser03");
        createAnswer("qid2", "やっぱカレーでーす。以上でーす", "test04", "testUser04");
        createAnswer("qid2", "実は…うどんが一番うまいんです！うどんならどれでもおいしいよ！", "test03", "testUser03");
        createAnswer("qid3", "オーバーライドは子供が親を上書きすんねん！", "test03", "testUser03");
        createAnswer("qid3", "共通の機能を持つ「親クラス」を引き継ぎつつ、特定の「子クラス」だけ一部の動作を変えたい場合に、同じ名前のメソッドを再定義して元の機能を上書きします。", "test04", "testUser04");
        createAnswer("qid4", "分かりません。すまんかったです。", "test02", "testUser02");
        createAnswer("qid4", "あるクラス（設計図）が持っている属性や機能を、別の新しいクラスに引き継がせる仕組み", "test04", "testUser04");
    }
